                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header d-flex justify-content-between align-items-center">
                                        <h4>User Overview</h4>
                                        <button class="btn" style="background-color: #339498; color: white;" onclick="window.location.href='signup_admin.php'">Create a New User</button>
                                    </div>
                                    <div class="card-body">
                                                    ...
                                                    if ($result->num_rows > 0) {
                                                        while ($row = $result->fetch_assoc()) {
                                                            ...
                                                            echo "<tr>
                                                                ...
                                                                <td>
                                                                    <a href='manage_user_details.php?id={$row['user_id']}' class='btn' style='background-color: #339498; color: white;'>Manage</a>
                                                                </td>
                                                            </tr>";
                                                        }
                                                    } else {
