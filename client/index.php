...
<title>proDX: The Digital Catalog for DOST X - Assisted Products</title>
                        ...
                        <div class="slideshow__text-wrap slideshow__overlay classic middle">
                            <div class="slideshow__text-content middle">
                                <div class="wrap-caption right">
                                    <h2 class="h1 mega-title slideshow__title">Sudsud Handicrafts</h2>
                                    <span class="mega-subtitle slideshow__subtitle">Inspired by the dreams and traditions of the Higanon and Talaandig elders, these intricately woven items are crafted from Sudsud (nut grass)
                                        by the talented artisans of the Damugu Weavers Association in Talakag, Bukidnon. These exquisite handicrafts not only showcase the rich cultural heritage of 
                                        the region but also embody sustainable practices, utilizing a readily available natural resource..</span>
                                    <span class="btn" href="javascript:void(0)" data-toggle="modal" data-target="#content_quickview">Inquire for Availability</span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="slideshow__text-wrap slideshow__overlay classic middle">
                            <div class="slideshow__text-content middle">
                                <div class="wrap-caption left">
                                    <h2 class="h1 mega-title slideshow__title">Slers Country Ham</h2>
                                    <span class="mega-subtitle slideshow__subtitle">by Slers Food</span>
                                    <span class="btn">Inquire now</span>
                                </div>
                            </div>
                        </div>
                    </div>
                        	...
                        	<div class="row">
                                ...
                                <div class="col-12 col-sm-6 col-md-6 col-lg-6">
                                	<div class="inner btmleft">
                                        <a href="#">	
                                            <img data-src="assets/images/collection/home11-grid-sm-banner3.jpg" src="assets/images/collection/home11-grid-sm-banner3.jpg" alt="Caps" title="Caps" class="blur-up lazyload" />
                                            <div class="ttl">
                                                Browse <h5>Grassroots Innovation</h5>
                                            </div>
                                        </a>
                                    </div>
                            	</div>   
        ...
        <div class="product-rows section">
        	<div class="container-fluid">
            	<div class="row">
                	<div class="col-12 col-sm-12 col-md-12 col-lg-12">
        				<div class="section-header text-center">
                            <h2 class="h2">TRENDING DOST-ASSISTED PRODUCTS</h2>
                        </div>
            		</div>
                </div>
	            <div class="productSlider-fullwidth grid-products grid-products-hover-btn">
                    <div class="col-12 item">
                        ...
                        <div class="product-image">
                            ...
                            <form class="variants add" action="#" onclick="window.location.href='product-details.html'"method="post">
                                <button class="btn btn-addto-cart" type="button" tabindex="0">View Item</button>
                            </form>
                        ...
                        <div class="product-details text-center">
                            ...
                            <div class="product-name">
                                <a href="product-details.html">Sudsud Bag</a>
                            </div>
                            <!-- End product name -->
                            <!-- product price -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="product-single__meta">
                                <h2 class="product-single__title">Sudsud Bag</h2>
                                <div class="prInfoRow">
                                    <div class="product-stock"> <span class="instock ">Made to Order</span> <span class="outstock hide">Unavailable</span> </div>
                                ...
                                <div class="product-single__description rte">
                                    <p>Inspired by the dreams and traditions of the Higanon and Talaandig elders, these intricately woven items are crafted from Sudsud (nut grass)
                                        by the talented artisans of the Damugu Weavers Association in Talakag, Bukidnon. These exquisite handicrafts not only showcase the rich cultural heritage of 
                                        the region but also embody sustainable practices, utilizing a readily available natural resource.</p>

                                   <p> "Damugu" holds profound meaning in both the tribal languages of the Higaonon and Talaandig peoples, translating to "dream." This evocative name embodies the 
                                       aspirations and hopes of the Lumad weavers from Barangay San Rafael in Talakag. Weaving, or "paglala," has been a vital cultural practice among the native 
                                       inhabitants since the 13th century. Traditionally, this intricate craft served not only as a means of creating functional items but also as a spiritual link, allowing the weavers to invoke protection and good health from the spirits. 
                                       Through their meticulous work, these weavers maintain a profound connection to their heritage and ancestors, ensuring the continuity of their rich cultural legacy.</p>
                                </div>
